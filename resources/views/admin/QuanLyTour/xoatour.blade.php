@vite('resources/js/deleteTour-admin.js')

<!-- Nút Xóa -->
<button type="button" class="btn btn-danger fs-5" data-bs-toggle="modal" data-bs-target="#deleteTourModal" data-tour-id="{{ $tour->id }}">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg" style="border-radius: 10px;" id="deleteModalContent">
            ...
            <div class="modal-footer">
                ...
                <form id="deleteTourForm" method="POST" action="{{ route('xoa_tour', $tour->id) }}">
                    @csrf
                    @method('DELETE')
